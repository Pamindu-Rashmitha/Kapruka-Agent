        ...
        {isOpen && (
          <>
            ...
            >
              ...
              <div className="relative z-10 flex items-center justify-between p-4 sm:p-5 border-b border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5">
                <h2 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2 drop-shadow-md">
                  <ShoppingBag size={18} className="text-primary drop-shadow-[0_0_8px_rgba(139,92,246,0.5)]" />
                  Your Cart
                </h2>
                <button
                  onClick={() => setIsOpen(false)}
              ...
              <div className="flex-1 overflow-y-auto p-4 sm:p-5 flex flex-col gap-3 custom-scrollbar relative z-10">
                {cart.length === 0 ? (
                  <motion.div
                  ...
                  cart.map(item => (
                    ...
                    >
                      <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-xl bg-gray-100 dark:bg-black/40 border border-gray-200 dark:border-white/10 overflow-hidden flex-shrink-0 relative group-hover:border-gray-300 dark:group-hover:border-white/20 transition-colors">
                        {item.imageUrl ? (
                      ...
                      <div className="flex-1 flex flex-col">
                        <h3 className="text-[13px] font-medium text-gray-800 dark:text-gray-200 line-clamp-2 leading-tight">{item.name}</h3>
                        <div className="mt-1 font-bold text-accent text-[13px]">
                        ...
                        <div className="mt-auto flex items-center gap-3 pt-2">
                          <div className="flex items-center bg-gray-100 dark:bg-black/40 rounded-lg border border-gray-200 dark:border-white/10 shadow-inner">
                            ...
                            <span className="w-8 text-center text-xs font-medium text-gray-900 dark:text-white">{item.quantity}</span>
                            <motion.button
                              whileTap={{ scale: 0.9 }}
                              onClick={() => updateQuantity(item.productId, item.quantity + 1)}
              ...
              <div className="p-4 sm:p-5 border-t border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-black/40 backdrop-blur-xl relative z-10">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-gray-500 dark:text-gray-400 font-medium text-sm">Subtotal</span>
                  <span className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-gray-900 dark:from-white to-gray-600 dark:to-gray-300 drop-shadow-sm">
                ...
                <motion.button
                  ...
                  className="w-full py-3 rounded-xl bg-gradient-to-r from-primary to-primary-dark text-white font-bold transition-all shadow-[0_0_20px_rgba(139,92,246,0.3)] hover:shadow-[0_0_30px_rgba(139,92,246,0.5)] border border-white/20 relative overflow-hidden group text-sm"
                >
